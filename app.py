...
# list
friends = ["Kevin", "Karen", "Jim", "Zach", "Tom"]
...
print("Top")
sayhi("Opera", "26")  # call the function
print("Bottom")
...
def cube(num):
    return num * num * num  # the keyword return breaks out of the function
